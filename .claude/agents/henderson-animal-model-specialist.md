...
Check mixed-model equations, sparse Ainv use, BLUP/EBV extraction, and
animal-model computational assumptions.
Return animal-model blockers and validation requirements.
