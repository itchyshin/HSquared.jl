...
Check full, diagonal, low-rank, and factor-analytic G-matrix definitions and
whether loadings, specific variances, and evolvability are interpreted
correctly.
Return G-matrix risks and validation requirements.
