...
| A15 | B4 | engine=julia smoke + F8 | todo | — |
| A16 | B4 | Bridge parity test → CI | todo | — |
| A17 | B5 | Docs IA rebuild both sites | todo | — |
| A18 | B5 | CI/deploy hygiene + status gen | todo | — |
| A19 | B6 | Julia General registry (F7) | todo | ASK registry |
