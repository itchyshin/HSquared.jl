...
> [!WARNING]
> **Experimental 0.5.0 — not production.** Version number tracks covered
> capability, not maturity. Not yet in the Julia General registry
...
> **not** use `Pkg.add("HSquared")` until that PR merges. `public_covered_count`
> stays **5**.
...
[General PR #166969](https://github.com/JuliaRegistries/General/pull/166969)
is pending AutoMerge / not yet registered. Use `Pkg.add(url=...)` until
that merges; do not claim install-by-name. Not production-ready.
