...
# Tip remesure (arc B, 2026-09-24): default pin = #363 SIMD on origin/main.
# Override with HSQ_EXPECTED_KERNEL_SHA when measuring a different kernel on purpose
# (pattern from origin/bench/selinv-arms-postkernel).
const EXPECTED_KERNEL_SHA = get(ENV, "HSQ_EXPECTED_KERNEL_SHA",
                                "c9eac4685ad8c6cec99d3a02f58fbe0cdcfd7031")
