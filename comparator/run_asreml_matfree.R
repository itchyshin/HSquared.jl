...
#   Blob SHA      : 295b718def1ea99ade2fd44a971db3df203893c2
#   Method        : read-only git-show from foreign lane; foreign files NOT edited.
#   STATUS        : PORTED, NOT RUN. Estimand comparison only (no ASReml timing).
#                   Companion to comparator/prepare_asreml_matfree.jl.
# ============================================================================
