...
- **Row 7** (SMOKE provenance): `main` supplied a settled sequence; this audit recorded it with one
  ...
  Totoro attribution** (`c0d35d5e` — authored by the orchestrator, not by `rose-closeout`, whose
  commit was the `3e00eaae` retraction it reverses), on primary evidence this
