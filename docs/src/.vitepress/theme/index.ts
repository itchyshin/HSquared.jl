// Derived from the DocumenterVitepress v0.3.4 theme template (MIT).
// Its full license is retained in DocumenterVitepress-LICENSE.txt. The only
// local change is the final overrides.css import.
