    ...
    <article class="hs-card">
      ...
      <table class="hs-table">
        ...
        <tbody>
          ...
          <tr><td>Marker screening</td><td><span class="hs-tag partial">experimental</span></td><td>direct fixed-effect, supplied-variance mixed, and supplied LOCO marker-scan helpers plus Manhattan/QQ plot data; no formula-driven GWAS/QTL, genomic-inflation calibration, or R formula activation.</td></tr>
