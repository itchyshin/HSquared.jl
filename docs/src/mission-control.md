    ...
    <article class="hs-card">
      ...
      <table class="hs-table">
        ...
        <tbody>
          ...
          <tr><td>Marker screening</td><td><span class="hs-tag partial">experimental</span></td><td>direct fixed-effect <code>single_marker_scan</code> plus Manhattan plot data; no mixed-model GWAS/QTL or R formula activation.</td></tr>
