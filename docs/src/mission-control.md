  ...
  <section class="hs-grid two" aria-label="evidence and gates">
    <article class="hs-card">
      ...
      <table class="hs-table">
        ...
        <tbody>
          ...
          <tr><td>Marker screening</td><td><span class="hs-tag partial">experimental</span></td><td>direct fixed-effect <code>single_marker_scan</code> plus supplied-variance <code>mixed_model_marker_scan</code> and Manhattan/QQ plot data; no formula-driven GWAS/QTL, genomic-inflation calibration, or R formula activation.</td></tr>
    ...
    <article class="hs-card">
      ...
      <ul class="hs-list">
        ...
        <li>No calibrated mixed-model p-values, interval-mapping or mixed-model LOD workflows, LOCO, plotting backend, advanced/correlated-marker multiple-testing workflow, or comparator-parity claim for marker scans.</li>
