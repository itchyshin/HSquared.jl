...
local copy-returning metadata accessors, and recovery checks, but loadings are
only sign-canonicalized; rotations and interpretation remain validation debt.
