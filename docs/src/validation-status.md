...
calibration protocol defines the future run plan and reporting gate for broad
multi-seed calibration, but it has not been executed; full rotation and
