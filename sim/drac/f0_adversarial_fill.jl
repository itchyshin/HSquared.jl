...
#   Introducing   : 533cf0f8c84e69624b6127d6736d96db4718d799 (2026-07-24)
#   Blob SHA      : 24a5edf1d9667dd05647b04b3a8719bb6e9c582e
#   Method        : read-only git-show from foreign lane; foreign files NOT edited.
#   STATUS        : PORTED, NOT RUN. High-fill adversarial generator / F0 bench.
#                   S6 DGP may also reuse adversarial() from
#                   sim/phase_s5_matfree_tail_recovery_gate.jl; this file is the
#                   standalone high-fill scaffold named in the S6 P2 prerequisite.
# ============================================================================
