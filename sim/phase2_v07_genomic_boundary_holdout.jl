...
const JULIA_BOUNDARY_IMPL_COMMIT = "47bba6da3d996db8a4655ffc8008cb7f4d131d19"
const R_BOUNDARY_IMPL_COMMIT = "088cc6a16e636318b08e3568164ecf35e1e02572"
...
function _fit_row(cell, seed, route, result, runtime, hashes)
    ...
    if fit === nothing
        ...
        return Any[cell.id, seed, route, false, "boundary_unresolved", 0,
    ...
    Any[cell.id, seed, route, fit.converged, fit.optimizer_status, fit.iterations,
