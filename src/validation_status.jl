const VALIDATION_STATUS_DATA = (
    ...
    (
        ...
        "Supplied-variance genomic solve plus a Julia-native comparator target only; no genomic variance-component estimation, no single-step, no external comparator parity.",
    ),
    (
        "V2-SNPBLUP",
        ...
        "Supplied-variance VanRaden method-1 marker model plus a Julia-native comparator target only; no external comparator, no weighted/Bayesian marker priors.",
    ),
    (
        "V2-SSHINV",
