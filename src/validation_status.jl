const VALIDATION_STATUS_DATA = (
    ...
    (
        ...
        "standard errors / likelihood-ratio tests for the covariances, broader multi-seed recovery calibration, a published Mrode multi-trait estimate, and JWAS/sommer/ASReml comparator parity",
