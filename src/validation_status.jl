const VALIDATION_STATUS_DATA = (
    ...
    (
        ...
        "Phase 1",
        "partial",
        "breeding_values(fit) is MME-backed at the fit's variance components; heritability, PEV, and reliability tests match hand checks and MME inverse blocks; variance components, heritability, PEV, and reliability also cover supplied-variance HendersonMMEResult objects.",
