const VALIDATION_STATUS_DATA = (
    ...
    (
        ...
        join((
            ...
            "The BLUPF90/AIREMLF90 starter packet now has a tested preflight: it generates machine-oriented data/pedigree/renum files with no header/comment records, validates row counts and target covariances against the serialized fixture, probes local BLUPF90-family executables, and provides an opt-in skip-safe runner; no BLUPF90-family executable has been run as evidence in CI.",
