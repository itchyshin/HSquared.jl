...
#
# Honesty: public_covered_count is hard-pinned to 6 — (1) the v0.1 univariate Gaussian
...
# POINT-ESTIMATE, NOT k≥3/not (x|g)/not non-Gaussian), (5) the opt-in direct–maternal
...
# default), and (6) the default-route t=2 unstructured multivariate Gaussian animal
# model (G10 R-public covered; k≥3 / diagonal stay experimental). The covered/partial/planned
# split is generated, never quoted in prose.
